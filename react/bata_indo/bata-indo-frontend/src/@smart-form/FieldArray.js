...
export default function FieldArray({ path, name, watch, control, register, setError, clearErrors, setValue, getValues, subFields, disabled, defaultValues, errors, layout, onChange, arrLayout, columns }) {
