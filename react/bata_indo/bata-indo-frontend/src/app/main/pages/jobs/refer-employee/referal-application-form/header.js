			...
			<div className="flex flex-col items-start max-w-full">
				<FuseAnimate animation="transition.slideRightIn" delay={300}>
					<Typography
						...
						component={Link}
						role="button"
						to={(props.type == 'new') ? "/app/jobs/refer-emp/ref-active-postings" : "/app/jobs/refer-emp/applicant-list"}
						color="inherit">
						<Icon className="text-20">
							arrow_back
						</Icon>
						<span className="mx-4">{(props.type == 'new') ? <Label labelId="BL00256" /> : 'Referral Applicants' }</span>
					</Typography>
				</FuseAnimate>
