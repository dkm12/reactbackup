...
import { getAdvanceImprests, selectAdvanceImprests } from '../store/empAdvanceImprestsSlice';
//import AdvanceImprestTableHead from './AdvanceImprestTableHead';
...
function AdvanceImprestTable(props) {
	const dispatch = useDispatch();
	const advanceImprests = useSelector(selectAdvanceImprests);
	const uuid = useSelector(({ auth }) => auth.user.uuid);
	const searchText = useSelector(({ advanceImprest }) => advanceImprest.empAdvanceImprests.searchText);
	const totalRecords = useSelector(({ advanceImprest }) => advanceImprest.empAdvanceImprests.totalRecords);
	...
	function handleClick(item) {
		props.history.push(`/app/employee-service/advance-imprest/${item.id}`);
	}
...
export default withRouter(AdvanceImprestTable);
