             ...
             <Grid xs={12} sm={2}>
                <Paper className="flex items-center max-w-512 p-4 mx-12 mb-8 mt-0 rounded-4" elevation={1}>
                    <TextField className={classes.root}
                        ...
                        onInput={onInput}
                        value={(formInput.transactionNumber ?? '')}
            ...
            <Grid xs={12} sm={2}>
                <Paper className="flex items-center max-w-512 p-4 mx-12 mb-8 mt-0 rounded-4" elevation={1}>
                    <TextField className={classes.root} 
                        ...
                        onChange={onInput}
                        value={(formInput.appliedOnFromDate1 ?? '')}
                ...
                <Paper className="flex items-center max-w-512 p-4 mx-12 mb-8 mt-0 rounded-4" elevation={1}>
                    <TextField className={classes.root} 
                        ...
                        onChange={onInput}
                        value={(formInput.appliedOnToDate ?? '')}
                        InputProps={{ disableUnderline: true }} type="date">
                    </TextField>
                </Paper>
            </Grid>
