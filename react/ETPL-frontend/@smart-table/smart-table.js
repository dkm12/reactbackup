...
import { STPagination, STSteppedPagination } from "./components";
...
export default class SmartTable extends React.Component {
  ...
  getProps(props) {
    ...
    calculatedProps.components = {
      ...SmartTable.defaultProps.components,
      ...calculatedProps.components,
    };
    calculatedProps.icons = {
      ...SmartTable.defaultProps.icons,
      ...calculatedProps.icons,
    };
    calculatedProps.options = {
      ...SmartTable.defaultProps.options,
      ...calculatedProps.options,
    };

    const localization = {
      ...SmartTable.defaultProps.localization.body,
  ...
  onQueryChange = (query, callback) => {
    ...
    this.setState({ isLoading: true, errorState: undefined }, () => {
      this.props
        ...
        .catch((error) => {
          const localization = {
            ...SmartTable.defaultProps.localization,
  ...
  renderFooter() {
    ...
    if (props.options.paging) {
      const localization = {
        ...SmartTable.defaultProps.localization.pagination,
    ...
    >
      {props.options.header && (
        <props.components.Header
          ...
          localization={{
            ...SmartTable.defaultProps.localization.header,
        ...
        >
          ...
          {props.options.toolbar && (
            <props.components.Toolbar
              ...
              localization={{
                ...SmartTable.defaultProps.localization.toolbar,
          ...
          {props.options.grouping && (
            <props.components.Groupbar
              icons={props.icons}
              localization={{
                ...SmartTable.defaultProps.localization.grouping,
