...
export const defaultProps = {
  ...
  columns: [],
  components: {
    Action: MComponents.STAction,
    Actions: MComponents.STActions,
    Body: MComponents.STBody,
    Cell: MComponents.STCell,
    Container: Container,
    EditCell: MComponents.STEditCell,
    EditField: MComponents.STEditField,
    EditRow: MComponents.STEditRow,
    FilterRow: MComponents.STFilterRow,
    Groupbar: MComponents.STGroupbar,
    GroupRow: MComponents.STGroupRow,
    Header: MComponents.STHeader,
    OverlayLoading: OverlayLoading,
    OverlayError: OverlayError,
    Pagination: TablePagination,
    Row: MComponents.STBodyRow,
    Toolbar: MComponents.STToolbar,
  },
  data: [],
  icons: {
