...
import { selectMainThemeDark } from 'app/store/core/settingsSlice';
...
const styles = theme => ({
	root: {
		...
		'&.Jan': {
			backgroundImage: "url('/app/assets/images/calendar/winter.jpg')",
		...
		'&.Mar': {
			backgroundImage: "url('/app/assets/images/calendar/spring.jpg')",
		...
		'&.Jun': {
			backgroundImage: "url('/app/assets/images/calendar/summer.jpg')",
		...
		'&.Sep': {
			backgroundImage: "url('/app/assets/images/calendar/autumn.jpg')",
			backgroundPosition: '0 40%'
		},
		'&.Oct': {
			backgroundImage: "url('/app/assets/images/calendar/autumn.jpg')",
