...
import DepartmentListTableHead from './DivisionListTableHead';
...
function DepartmentListTable(props) {
	...
	useEffect(() => {
		async function updateProductState() {
			let getApi = await masterApi.getAlldivisions();
			let Array = [];
			_.isArray(getApi)
	...
	function handleClick(item) {
		props.history.push(`/app/master/division/create/${item.divId}`);
	}
