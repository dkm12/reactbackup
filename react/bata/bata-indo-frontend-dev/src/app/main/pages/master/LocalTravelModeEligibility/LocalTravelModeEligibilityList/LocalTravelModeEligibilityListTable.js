...
import LocalTravelModeEligibilityListTableHead from './LocalTravelModeEligibilityListTableHead';
...
function DepartmentListTable(props) {
	...
	useEffect(() => {
		async function updateProductState() {
			let getApi = await masterApi.getLocTvlModeElig();
			let Array = [];
			_.isArray(getApi)
	...
	function handleClick(item) {
		props.history.push(`/app/master/localeligibility/create/${item.ltmeId}`);
	}
