...
import LeaveCategoryListTableHead from './SubDepartmentListTableHead';
...
function DepartmentListTable(props) {
	...
	useEffect(() => {
		async function updateProductState() {
			let getApi = await masterApi.getAllSubDepartments();
			let Array = [];
			_.isArray(getApi)
	...
	function handleClick(item) {
		props.history.push(`/app/master/subdepartment/create/${item.sbdId}`);
	}
