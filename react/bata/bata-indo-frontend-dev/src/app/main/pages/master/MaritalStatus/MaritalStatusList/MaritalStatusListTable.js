...
import MaritalStatusListTableHead from './MaritalStatusListTableHead';
...
function DepartmentListTable(props) {
	...
	useEffect(() => {
		async function updateProductState() {
			let getApi = await masterApi.getAllmaritalStatus();
			let Array = [];
			_.isArray(getApi)
	...
	function handleClick(item) {
		props.history.push(`/app/master/maritalStatus/create/${item.msId}`);
	}
