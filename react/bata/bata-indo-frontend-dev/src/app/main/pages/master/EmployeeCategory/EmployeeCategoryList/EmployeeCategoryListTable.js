...
import EmployeeCategoryListTableHead from './EmployeeCategoryListTableHead';
...
function DepartmentListTable(props) {
	...
	useEffect(() => {
		async function updateProductState() {
			let getApi = await masterApi.getAllEmployeeCategorys();
			let Array = [];
			_.isArray(getApi)
	...
	function handleClick(item) {
		props.history.push(`/app/master/employeecategory/create/${item.ecId}`);
	}
