...
import LeaveCategoryListTableHead from './TravelRateTableHead';
...
function DepartmentListTable(props) {
	...
	useEffect(() => {
		async function updateProductState() {
			let getApi = await masterApi.getAllTravelRates();
			let Array = [];
			_.isArray(getApi)
	...
	function handleClick(item) {
		props.history.push(`/app/master/travelrate/create/${item.trId}`);
	}
