...
import EmployeeTypeListTableHead from './EmployeeTypeListTableHead';
...
function DepartmentListTable(props) {
	...
	useEffect(() => {
		async function updateProductState() {
			let getApi = await masterApi.getAllEmployeeTypes();
			let Array = [];
			_.isArray(getApi)
	...
	function handleClick(item) {
		props.history.push(`/app/master/employeeType/create/${item.etId}`);
	}
