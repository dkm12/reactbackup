...
import CityListTableHead from './CityTypeMappigTableHead';
...
function CityListTable(props) {
	...
	useEffect(() => {
		async function updateProductState() {
			let CityType = await masterApi.getAllCityTypeMappings();
			let Array = [];
			_.isArray(CityType)
	...
	function handleClick(item) {
		props.history.push(`/app/master/citytypemapping/create/${item.ctmId}`);
	}
