...
class STPaginationInner extends React.Component {
  ...
  render() {
    ...
    const localization = {
      ...STPaginationInner.defaultProps.localization,
...
STPaginationInner.defaultProps = {
...
const STSteppedPagination = withStyles(actionsStyles, { withTheme: true })(
  STPaginationInner
);

export default STSteppedPagination;
