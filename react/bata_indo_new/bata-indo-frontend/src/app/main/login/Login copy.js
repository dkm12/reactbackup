						...
						<CardContent className="flex flex-col items-center justify-center w-full py-96 max-w-320">
							<FuseAnimate delay={300}>
								<div className="flex items-center mb-32">
									<img className="logo-icon w-48" src="app/assets/images/logos/fuse.svg" alt="logo" />
							...
							>
								<Tab
									icon={
										<img
											...
											src="app/assets/images/logos/jwt.svg"
											alt="firebase"
										/>
									}
									className="min-w-0"
								...
								<Tab
									icon={
										<img className="h-40" src="app/assets/images/logos/firebase.svg" alt="firebase" />
									}
									className="min-w-0"
									label="Firebase"
								/>
								<Tab
									icon={<img className="h-40" src="app/assets/images/logos/auth0.svg" alt="auth0" />}
									className="min-w-0"
									label="Auth0"
								/>
							</Tabs>
