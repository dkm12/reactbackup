...
import LeaveCategoryListTableHead from './SalutationListTableHead';
...
function DepartmentListTable(props) {
	...
	useEffect(() => {
		async function updateProductState() {
			let getApi = await masterApi.getAllSalutations();
			let Array = [];
			_.isArray(getApi)
	...
	function handleClick(item) {
		props.history.push(`/app/master/salutation/create/${item.saluId}`);
	}
