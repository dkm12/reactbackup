...
import OrganizationalListTableHead from './OrganizationalListTableHead';
...
function DepartmentListTable(props) {
	...
	useEffect(() => {
		async function updateProductState() {
			let getApi = await masterApi.getAllOrganizationalValues();
			let Array = [];
			_.isArray(getApi)
	...
	function handleClick(item) {
		props.history.push(`/app/master/organizational/create/${item.orgValId}`);
	}
