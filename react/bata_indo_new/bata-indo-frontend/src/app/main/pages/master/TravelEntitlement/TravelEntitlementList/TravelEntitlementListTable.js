...
import LeaveCategoryListTableHead from './TravelEntitlementListTableHead';
...
function DepartmentListTable(props) {
	...
	useEffect(() => {
		async function updateProductState() {
			let getApi = await masterApi.getAllTravelEntitlement();
			let Array = [];
			_.isArray(getApi)
	...
	function handleClick(item) {
		props.history.push(`/app/master/travelentitlement/create/${item.teId}`);
	}
