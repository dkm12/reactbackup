...
import { getRefJobsList, selectRefJobPostings } from '../../store/refEmpActivePostingSlice'
...
import SearchFilter from '../newPostingLists/filter'
...
function JobPostingTable(props) {
	...
	const totalRecords = useSelector(({ jobs }) => jobs.refEmpActivePostings.totalRecords);
