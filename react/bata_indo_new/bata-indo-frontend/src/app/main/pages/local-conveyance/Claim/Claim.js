...
import VerticalLinearStepper from '@components/History/innerPage';
							...
							},
							{
								...
								fields: [
									...
									},
									{
										...
										pattern: {
											value: regex.distanceReg,
											message: 'Please enter amount between 1 to 5000'
										},
										// validationProps: {
										// 	manual: [
										// 		{
								...
								fields: [
									...
									},
									{
										...
										pattern: {
											...
											message: 'Please enter amount between 1 to 10000000000'
										},
										validationProps: {
											required: 'This is a mandatory field'
										},
									...
									},
									{
										...
										pattern: {
											value: regex.amountReg0,
											message: 'Please enter amount between 0 to 10000000000'
										},
										// validationProps: {
										// 	enable: 'this*modeOfTravel !== "Online Car Taxi"',
										// 	required: 'This is a mandatory field',
					...
					< div className="p-16 sm:p-24" >
						...
						{localConveyanceId !== "new" && localConveyance && localConveyance.lcId && (
							...
							<SmartForm
								...
								onCancel={onCancel}
								// onChange={data => handleDataChange(data)}
								buttons={localConveyance && localConveyance.outcome && localConveyance.outcome.toUpperCase() === "SUBMIT" && localConveyance.statusName.toUpperCase() !== "Returned".toUpperCase() ? null : ['save', 'submit', 'cancel']}
							/>
							<div style={{display: 'none'}}>
								<div ref={componentRef} style={{padding: '100px'}} >
								<div className={classes.root2}>Local Conveyance Claim</div>
									<SmartForm
										defaultValues={localConveyance}
										template={template}
									/>
									 {localConveyance && localConveyance.lcId !== null && 
									 localClaimHistorys && _.isArray(localClaimHistorys) ? 
									<><div className={classes.root2}>Approver History</div>
									<VerticalLinearStepper data={localClaimHistorys}/></> : ""}
								</div>
							</div>
							{localConveyance && localConveyance.outcome && localConveyance.outcome.toUpperCase() === "SUBMIT" && localConveyance.statusName.toUpperCase() !== "Returned".toUpperCase() ?
								<div className="flex justify-center">
									<Button variant="contained" className="mr-5" color="primary" align="center" type="button" onClick={handlePrint}>
										Print
									</Button>
									<Button variant="contained" className="ml-5" color="primary" align="center" type="button" onClick={onCancel}>
										Cancel
									</Button>
								</div> 
							: null}
