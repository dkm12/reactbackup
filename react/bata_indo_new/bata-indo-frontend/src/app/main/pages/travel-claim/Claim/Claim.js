				...
				fields: [
					{
						...
						subFields: [
							...
							},
							{
								...
								pattern: {
									value: regex.amountReg,
									message: 'Tax Amount should be between 1 to 10000000000'
								},
								validationProps: {
									validateRow: ['hotelName', 'cityCode', 'trvltFrom', 'trvltTo', 'billNo', 'trvlAmt', 'taxAmt'],
									required: 'This is a mandatory field.',
					...
					fields: [
						{
							...
							columns: {
								...
								titles: GetLabelWithLang(['BL00130', 'BL00131', 'BL00132', 'BL00133', 'BL00223', 'BL00197', 'BL00123'], lang),
						...
						{travelClaimId !== "new" && travelClaim && travelClaim.id && (
							...
							<SmartForm
								...
								template={template}
									...
									onCancel={onCancel}
									//onChange={data => handleDataChange(data)}
									buttons={travelClaim && travelClaim.outcome && travelClaim.outcome.toUpperCase() === "SUBMIT" && travelClaim.statusName.toUpperCase() !== "Returned".toUpperCase() ? null : ['save', 'submit', 'cancel']}
								/>
								<div style={{display: 'none'}}>
									<div ref={componentRef} style={{padding: '100px'}} >
										<SmartForm
											...
											template={template}
										/>
									 	{travelClaim && travelClaim.id !== null &&
										 claimHistorys &&  _.isArray(claimHistorys) ? 
										<><div className={classes.root2}>Approver History</div>
										<VerticalLinearStepper data={claimHistorys}/></> : ""}
									</div>
								</div>
								{travelClaim && travelClaim.outcome && travelClaim.outcome.toUpperCase() === "SUBMIT" && travelClaim.statusName.toUpperCase() !== "Returned".toUpperCase() ?
