...
function ApproveClaimTable(props) {
	...
	const searchText = useSelector(({ travelClaim }) => travelClaim.empApproveClaims.searchText);
	const totalRecords = useSelector(({ travelClaim }) => travelClaim.empApproveClaims.totalRecords);
	...
	function handleClick(item) {
		props.history.push(`/app/claim-requests/approve-travel-claim/${item.id}`);
	}
