					...
					<div className="p-16 sm:p-24">
						...
						{cashReimbursementId !== "new" && cashReimbursement && cashReimbursement.id && (
							...
							<SmartForm
								...
								onCancel={onCancel}
								//onChange={data => handleDataChange(data)}
								buttons={cashReimbursement && cashReimbursement.outcome && cashReimbursement.outcome.toUpperCase() === "SUBMIT" && cashReimbursement.statusName.toUpperCase() !== "Returned".toUpperCase() ? null : ['save', 'submit', 'cancel']}
							/>
							<div style={{display: 'none'}}>
								<div ref={componentRef} style={{padding: '100px'}}>
									<SmartForm
										...
										template={template}
									/>
									 {cashReimbursement && cashReimbursement.id !== null 
							...
							{cashReimbursement && cashReimbursement.outcome && cashReimbursement.outcome.toUpperCase() === "SUBMIT" && cashReimbursement.statusName.toUpperCase() !== "Returned".toUpperCase() ?
