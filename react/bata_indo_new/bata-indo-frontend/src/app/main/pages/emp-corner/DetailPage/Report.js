...
import { saveReport } from '@components/EmpCorner/store/empCornerFormSlice';
...
function Report({ id, type }) {
    ...
    async function onSubmit(values) {
        ...
        if (values.button.toUpperCase() === "SUBMIT") {
            ...
            lrData.remark = values.data.remark;
            lrData.reportedEntityId = id;
            lrData.reportedEntityType = type.toUpperCase();
            console.log(lrData);
            await dispatch(saveReport(lrData));
