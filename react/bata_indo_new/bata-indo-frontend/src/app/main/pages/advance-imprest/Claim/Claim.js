					...
					<div className="p-16 sm:p-24">
						...
						{advanceImprestId !== "new" && advanceImprest && advanceImprest.id && (
							...
							<SmartForm
								...
								onCancel={onCancel}
								//onChange={data => handleDataChange(data)}
								buttons={advanceImprest && advanceImprest.outcome && advanceImprest.outcome.toUpperCase() === "SUBMIT" && advanceImprest.statusName.toUpperCase() !== "Returned".toUpperCase() ? null : ['save', 'submit', 'cancel']}
							/><div style={{display: 'none'}}>
							<div ref={componentRef} style={{padding: '100px'}} >
							<div className={classes.root2}>Advance Imprest Claim</div>
								<SmartForm
									defaultValues={advanceImprest}
									template={template}
								/>
								{advanceImprest && advanceImprest.id !== null &&
						...
						{advanceImprest && advanceImprest.outcome && advanceImprest.outcome.toUpperCase() === "SUBMIT" && advanceImprest.statusName.toUpperCase() !== "Returned".toUpperCase() ?
