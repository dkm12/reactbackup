...
const apiUrl = 'http://k8s-batadev-ingressd-0836da90f9-944557268.ap-south-1.elb.amazonaws.com/api' // Dev

// const apiUrl = 'http://k8s-batauat-ingressu-7b12503836-1375637542.ap-south-1.elb.amazonaws.com/api' // UAT

//const apiUrl = 'http://k8s-bataprod-ingressp-589733a52d-1251569734.ap-south-1.elb.amazonaws.com/api' // Direct PROD
// const apiUrl = 'https://api.mybataid.com/api' // PROD


const csvURL = 'http://k8s-batadev-ingressd-0836da90f9-944557268.ap-south-1.elb.amazonaws.com'
...
export default {
    ...
    pollSurvey: {
        getAllMaster: `${apiUrl}/training/survey/get-all`,
        getAllActive: `${apiUrl}/training/survey/get-all-active-surveys`,
        save: `${apiUrl}/training/survey/save`,
        getById: `${apiUrl}/training/survey/get-by-id/`,
        updateById: `${apiUrl}/training/survey/update-by-id/`,
        updateStatusById: `${apiUrl}/training/survey/update-status/`,
        saveAns: `${apiUrl}/training/poll/save`,
        getGraph: `${apiUrl}/training/poll/result/`,
    },
    localConveyance: {
        ...
        getClaimHr: `${apiUrl}/login-service/role/user-list/CLAIM-HR`,
    ...
    leaveRequest: {
        ...
        forHr: `${apiUrl}/leave/emp-leave/for-hr-list`,
    ...
    applicants: {
        ...
        checkDuplicate: `${apiUrl}/user/user-info/check-duplicate`,
        newJoineeWithoutRef: `${apiUrl}/________/___________/_______________`
    },
    appreciation: {
    ...
    training: {
        save: `${apiUrl}/training/training/save`,
        getAll: `${apiUrl}/training/training/get-all`,
        getById: `${apiUrl}/training/training/get-by-id/`,
        updateById: `${apiUrl}/training/training/update-by-id`,
        getAllActiveTrainings: `${apiUrl}/training/training/get-all-active-trainings`,
        updateStatus: `${apiUrl}/training/training/update-status`,
        openTrainingApplication: `${apiUrl}/training/training/get-all-active-trainings`,
        appliedTrainingApplication: `${apiUrl}/training/training-application/my-applied-trainings`,
        applyRequest: `${apiUrl}/training/training-application/save`,
        pendingApproval: `${apiUrl}/training/training-application/pending-approval`,
        getTRNGAPPROVERL1: `${apiUrl}/login-service/role/user-list/TRNG-APPROVER-L1`,
        runWorkflow: `${apiUrl}/training/training-application/run-workflow`,
        getByTrngAppId: `${apiUrl}/training/training-application/get-by-trngAppId/`,
        viewAll: `${apiUrl}/training/training-application/view-all`,
        getWorkflowHistory: `${apiUrl}/leave/emp-leave-trx/get-workflow-history`
    },
    banner: {
